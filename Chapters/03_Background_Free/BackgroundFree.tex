\chapter[Background-Free Imaging]{Background Suppression in Imaging Gold
Nanorods through Detection of Anti-Stokes Emission}
\label{ch:Imaging}

\blfootnote{This chapter has been published in Biophysical Journal 111, 2492-2499 (2016).}
...
\dropcap{H}{igh}-resolution microscopy has become an indispensable tool for
...
wavelength and therefore the filters are blocking it. Careful experiments
...
around $200\kCPS$, two orders of magnitude higher than that observed without the
dye.
