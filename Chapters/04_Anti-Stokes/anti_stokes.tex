...
\textbf{ Luminescence from single gold nanoparticles can be observed when
...
resonance. These particles can therefore be excited at one of those energies;
the transverse resonance corresponds to a wavelength of $532\nm$ and will give
...
In this work luminescence is referred to the emission from nanoparticles
observed at energies different from the excitation energy. Normally it is
expected that after absorption of a photon, the electrons in the particle will
relax and the emitted photon will appear at lower energies than the excitation.
This emission is called the Stokes-shifted emission and is normally employed for
imaging purposes. However gold nanoparticles when excited in resonance also
present a very efficient emission at higher energies. This anti-Stokes emission
from nanorods has been largely overlooked and its characterization is the
