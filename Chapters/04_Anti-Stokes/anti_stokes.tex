...
\textbf{ In this work luminescence is referred to the emission from
nanoparticles observed at energies different from the excitation energy.
Normally it is expected that after absorption of a photon, the electrons in the
particle will relax and the emitted photon will appear at lower energies than
the excitation. If this is the case, the emission is called Stokes-shifted;
however gold nanoparticles when excited in resonance also present a very
efficient emission at higher energies. This anti-Stokes emission from nanorods
has been largely overlooked and its characterization is the cornerstone of this
work.}
