...
\externaldocument{anti_stokes_paper_supporting}
...
\begin{document}
\maketitle
\abstract{Nano-thermometry is a challenging field that can open the door to very
...
Most physical, chemical, biological processes depend on temperature.
...
Particles that can withstand higher excitation powers and that have a well
defined plasmon resonance are of great interest, because they would allow to
employ a single wavelength and also to reduce the exposure times to record the
spectra. A well defined plasmon resonance also lowers the uncertainties
...
not coincide with the particles under study, leading to larger errors.
