...
\vspace{0.3cm} & \vspace{0.3cm} \\
 ...
 Khatua,\textit{$^{a}$}\textit{$^{b}$} and Michel Orrit$^{\ast}$\textit{$^{a}$}} \\%Author names go here instead of "Full name", etc.
...
\includegraphics{head_foot/dates} & \noindent\normalsize{	Single gold nanorods exhibit great opportunities for
	...
	the surface of the particles, preserving their specific optical properties.} \\%The abstrast goes here instead of the text "The abstract should be..."
...
\footnotetext{\textit{$^{a}$~Huygens-Kamerlingh Onnes, Leiden, The Netherlands}}
\footnotetext{\textit{$^{b}$~Present address: Indian Institute of Technology-
Gandhinagar, Ahmedabad,  India. }}
\footnotetext{\textit{$^{\ast}$~E-mail: orrit@physics.leidenuniv.nl}}
%Please use \dag to cite the ESI in the main text of the article.
%If you article does not have ESI please remove the the \dag symbol from the title and the footnotetext below.
\footnotetext{\dag~Electronic Supplementary Information (ESI) available: SEM
Images of nanoparticles, bulk spectra and background spectra.
